...
class AttentionESPN(nn.Module):
    ...
    Args:
        ...
        agg:                  MessageLayer aggregation for the bond/radial/qq
                              stages — one of AGG_MODES = ("mean", "sum",
                              "max", "multi") (default "mean"). Stage 2 (AQ)
                              always uses cross-attention regardless of this
                              setting.
